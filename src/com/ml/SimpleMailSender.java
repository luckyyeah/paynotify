...
public class SimpleMailSender {
	...
	//	mailMessage.setRecipient(Message.RecipientType.TO, to);
		...
		String[] receivers = mailInfo.getToAddresses();
	...
	public static void sendEmail(String subject,String content) throws Exception{
		...
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("yeahrh@163.com");
		mailInfo.setPassword("forever");// 您的邮箱密码dgwyvcgzmczibhhi
										// qoduwpjtcnaycabd
		mailInfo.setFromAddress("yeahrh@163.com");
		mailInfo.setToAddress("10099767@qq.com");
		String[] toAddresses = CommonUtil.getProperty("MAIL_LIST").split(",");
	...
	public static void main(String[] args) throws Exception {
		...
		mailInfo.setFromAddress("yeahrh@163.com");
		mailInfo.setToAddress("10099767@qq.com");
		String[] toAddresses = new String[] { "10099767@qq.com", "7071496@qq.com" };
		mailInfo.setToAddresses(toAddresses);
